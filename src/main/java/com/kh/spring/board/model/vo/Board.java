...
public class Board {
	...
	public Board(int bId, String bTitle, String bWriter, String bContent, String originFileName, String renameFileName,
	...
	public String toString() {
		return "Board [bId=" + bId + ", bTitle=" + bTitle + ", bWriter=" + bWriter + ", bContent=" + bContent
				+ ", originFileName=" + originalFileName + ", renameFileName=" + renameFileName + ", bCount=" + bCount
